		...
		<table width="550" text-align="center">
			...
			<tr>
				...
				<c:choose>
					...
					onclick = "location.href='reviewlist.do?page=${page}'">목록으로 돌아가기</button>
					
					</c:when>
					<c:when test="isNAN('${about  }')">
					<button type="button" class="btn btn-primary" style="background-color:orange; border:0px"
					onclick = "location.href='showrecipedetail.do?num=${num }&page=${page}'">목록으로 돌아가기</button>
