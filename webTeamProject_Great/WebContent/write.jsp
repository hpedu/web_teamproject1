...
<form action="writeReview.do" method="post" name="frm"> <!--  enctype="multipart/form-data" -->
<input type="hidden" name="about" value="${param.about }">
<input type="hidden" name="aboutname" value="${param.aboutname }">

<table border="1" align="center" width="80%" style="table-layout:fixed;">
	<tr>
		<th align="center">작성자</th>
		<td><input type="text" name="writer" value="${sessionScope.login.id}" readonly="readonly" style="width:99%;"></td>	
	</tr>
	<tr>
		<th>제목</th>
