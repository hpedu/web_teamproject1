...
//String path1 = "C:/jsh/webpro2/eclipse/workspace/TourProject/WebContent/upload"; // 이미지가 저장될 주소1

String path2 = request.getSession().getServletContext().getRealPath("/") + File.separator +"upload"+File.separator+((MemberVO)(session.getAttribute("login"))).getId();
File file = new File(path2);
if(!file.exists()){
	file.mkdirs();
} 

String path = "./upload"+File.separator+((MemberVO)(session.getAttribute("login"))).getId(); //즉시 새로고침되도록
