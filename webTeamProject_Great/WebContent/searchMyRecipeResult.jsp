...
<body>
	...
	<div class="container" align="center" width="1024px">
		...
		<td colspan="2" style=" padding:5px; text-align : center">
			<h2 align="center">나만의 레시피</h2></td>
			<br>
		</tr>
		
		<c:choose>
		
			<c:when test="${rlise == null }">
			
			<tr>
			
			<td colspan="2" style=" padding:5px">
			<br><br>
			<h4>아직 등록한 레시피가 없습니다.</h4><br>
			나만의 비법 레시피를 등록해보세요! <button type="button" class="btn btn-primary" style="background-color :  orange; border:0px;" onclick="location.href = 'reciperegist.jsp'">레시피 등록하기</button>
			</td>
			</tr>
			</c:when>
			<c:otherwise>
